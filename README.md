...
1. **毎週課題を始める際は、`main`ブランチから作業ブランチを作成する（例：`feature/book-list-api`）**
2. **課題を提出する際は、プルリクエストを`main`ブランチ向きに作成する**
3. **課題のテキストをそのまま ChatGPT 等のAIに貼り付けて実装するのは禁止**
4. **15分考えてもわからない場合は質問する**
> #### 【質問フォーマット】
>
>**タイトル**
> 
